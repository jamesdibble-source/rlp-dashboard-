...
const { getDb, makeDedupKey } = require(path.join(__dirname, 'db'));
...
try {
  ...
  const allLots = db.prepare("SELECT rowid, address, suburb, state, lot_size, dedup_key FROM lots").all();
  const keyMap = new Map(); // dedupKey -> [rowids]
  const updateKey = db.prepare("UPDATE lots SET dedup_key = ? WHERE rowid = ?");
  
  for (const lot of allLots) {
    const key = makeDedupKey(lot.address, lot.suburb, lot.state, lot.lot_size);
...
try {
  ...
  const nswMap = {
    'Sydney South West': /oran park|leppington|catherine field|gledswood hills|gregory hills|camden|spring farm|elderslie|currans hill|mount annan|narellan|harrington park|cobbitty|austral|kemps creek|rossmore|edmondson park|denham court|bardia|minto|airds|campbelltown|macquarie fields|ingleburn|glenfield|cecil hills|cecil park|bringelly|luddenham|greendale|wallacia|the oaks|picton|maldon|wilton|razorback|douglas park|appin|menangle|thirlmere|tahmoor|bargo|buxton|couridjah|yanderra|cawdor/i,
    'Sydney North West': /marsden park|schofields|box hill|rouse hill|kellyville|the ponds|riverstone|vineyard|colebee|tallawong|north kellyville|bella vista|baulkham hills|castle hill|oakville|alex avenue|elara|stanhope gardens|glenwood|parklea|quakers hill|dean park|mount druitt|rooty hill|minchinbury|st marys|penrith|jordan springs|cranebrook|glenmore park|regentville|south penrith|kingswood|werrington|caddens|claremont meadows|cambridge park/i,
    'Sydney West': /badgerys creek|luddenham|kemps creek|cecil park|bringelly|greendale|wallacia|orchard hills|mulgoa|silverdale|warragamba|emu plains|blaxland|springwood|lapstone|leonay/i,
    'Hunter': /maitland|cessnock|thornton|gillieston heights|chisholm|aberglasslyn|heddon greta|cliftleigh|raworth|farley|lochinvar|huntlee|north rothbury|branxton|greta|rutherford|east maitland|largs|bolwarra|telarah|metford|morpeth|raymond terrace|medowie|wallalong|dungog|singleton|muswellbrook|aberdeen|scone|kurri kurri|weston|pelaw main|bellbird|neath|abermain|kitchener|ellalong/i,
    'Newcastle': /newcastle|charlestown|lambton|merewether|wallsend|maryland|fletcher|cameron park|edgeworth|cardiff|glendale|macquarie hills|argenton|warners bay|valentines|speers point|toronto|morisset|cooranbong|bonnells bay|lake macquarie|belmont|swansea|caves beach|redhead|dudley|windale|kahibah/i,
    'Central Coast': /hamlyn terrace|woongarrah|wadalba|wyong|san remo|gorokan|toukley|halekulani|budgewoi|blue haven|lake haven|kanwal|charmhaven|morisset|cooranbong|jilliby|yarramalong|ourimbah|berkeley vale|tumbi umbi|killarney vale|erina|terrigal|gosford|point clare|tascott|kariong|somersby|woy woy|umina beach|ettalong beach|kincumber|avoca beach|copacabana|macmasters beach/i,
    'Illawarra-Shoalhaven': /calderwood|tullimbar|albion park|shell cove|flinders|dunmore|haywards bay|gerringong|berry|nowra|bomaderry|worrigee|south nowra|north nowra|shoalhaven heads|culburra beach|callala bay|vincentia|sanctuary point|sussex inlet|jervis bay|ulladulla|mollymook|milton|kiama|jamberoo|minnamurra|shellharbour|barrack heights|warilla|lake illawarra|unanderra|figtree|cordeaux heights|farmborough heights|wollongong|dapto|horsley|west dapto|kembla grange|avondale|huntley|marshall mount|tongarra|croom|calderwood valley/i,
    'Mid North Coast': /port macquarie|lake cathie|bonny hills|laurieton|kew|thrumster|sovereign hills|innes lake|lighthouse beach|north haven|camden haven|wauchope|coffs harbour|moonee beach|sapphire beach|emerald beach|korora|woolgoolga|urunga|sawtell|toormina|nambucca heads|macksville|scotts head|south west rocks|kempsey|crescent head|frederickton/i,
    'Northern Rivers': /ballina|lennox head|byron bay|bangalow|lismore|goonellabah|alstonville|wollongbar|casino|grafton|south grafton|junction hill|maclean|yamba|iluka|evans head|woodburn|coraki|kyogle|murwillumbah|tweed heads|pottsville|cabarita beach|kingscliff|chinderah|banora point|terranora/i,
    'New England': /tamworth|calala|hillvue|westdale|moore creek|nemingha|kootingal|armidale|glen innes|inverell|gunnedah|narrabri|moree|tenterfield|uralla|walcha/i,
    'Central West': /orange|bathurst|dubbo|mudgee|cowra|parkes|forbes|lithgow|kelso|glenroi|blayney|millthorpe|spring hill|lucknow|molong|manildra|portland|wallerawang|llanarth|calare|summer hill creek/i,
    'South Coast': /batemans bay|moruya|narooma|eurobodalla|bega|merimbula|pambula|tathra|eden|bermagui|cobargo|wolumla|tura beach|mirador/i,
    'Riverina-Murray': /wagga wagga|albury|griffith|leeton|narrandera|deniliquin|hay|west wodonga|lavington|thurgoona|glenroy|estella|boorooma|lloyd|lake albert|springdale heights|baranduda/i,
  };
  const qldMap = {
